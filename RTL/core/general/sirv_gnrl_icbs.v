...
module sirv_gnrl_icb2axi # (
  ...
  output [3:0] o_axi_aruser_id,
  output o_axi_aruser_ap,
  ...
  output [3:0] o_axi_awuser_id,
  output o_axi_awuser_ap,
  ...
  output o_axi_wlast,
  input  [3:0] o_axi_wusero_id,
  input  o_axi_wusero_last,
  ...
  wire [3:0] i_axi_aruser_id;
  wire i_axi_aruser_ap;
  ...
  wire [3:0] i_axi_awuser_id;
  wire i_axi_awuser_ap;
  ...
  wire i_axi_wlast;
  //wire i_axi_wusero_last;
  wire i_axi_wusero_id;
