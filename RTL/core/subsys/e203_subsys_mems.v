...
sirv_gnrl_icb2axi # (
  ...
  .DW   (`E203_XLEN) 
    ...
    .o_axi_aruser_ap (expl_axi_aruser_ap),
    .o_axi_aruser_id (expl_axi_aruser_id),
    ...
    .o_axi_awuser_ap (expl_axi_awuser_ap),
    .o_axi_awuser_id (expl_axi_awuser_id),
    ...
    .o_axi_wusero_id (expl_axi_wusero_id),
    .o_axi_wusero_last (expl_axi_wusero_last),
...
ddr #(
    ...
    .axi_araddr    (expl_axi_araddr ),
    .axi_arlen     (expl_axi_arlen  ),
    .axi_aruser_ap (expl_axi_aruser_ap),
    .axi_aruser_id (expl_axi_aruser_id),

    .axi_awvalid   (expl_axi_awvalid),
    .axi_awready   (expl_axi_awready),
    .axi_awaddr    (expl_axi_awaddr ),
    .axi_awlen     (expl_axi_awlen  ),
    .axi_awuser_ap (expl_axi_awuser_ap),
    .axi_awuser_id (expl_axi_awuser_id),
  
    .axi_rvalid    (expl_axi_rvalid ),
    .axi_rdata     (expl_axi_rdata  ),
    .axi_rlast     (expl_axi_rlast  ),
    .axi_rid       (expl_axi_rid    ),
